...
private:
  ...
  void parseRowsFromCloudMsg(const sensor_msgs::PointCloud2::ConstPtr &cloud, PC_ptr &cloud_processed, std::vector<int> &rows_start_indices,
                             std::vector<int> &rows_end_indices, float &processing_time);
  void parseRowsFromOS1CloudMsg(const sensor_msgs::PointCloud2::ConstPtr &cloud, PC_ptr &cloud_processed, std::vector<int> &rows_start_indices,
                                std::vector<int> &rows_end_indices, float &processing_time);
